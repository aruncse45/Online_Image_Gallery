...
<body>
    <div id="full">    
        ...
        echo "<img src='image/".$row['image']."' style='height:200px; width: 200px;  margin-left:10px; margin-top:10px; '>";
        echo "<input  type='button' name='approved' value='approve' >";
         echo "<input  type='button' name='delete' value='delete' >";
         echo "</div>"; 
         echo "</form>";

         if(isset($_POST["approved"])){
         	$sql="DELETE * from share where id=".$row['id']."";
         	mysqli_query($connection,$sql);			
			$sql1="INSERT into  final_share values ('".$row['image']."')";
